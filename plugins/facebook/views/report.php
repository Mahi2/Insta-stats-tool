<?php defined('ALTUMCODE') || die() ?>
    ...
    <div class="margin-bottom-6">
        <div class="d-flex justify-content-between">
            ...
            <a href="<?= csv_link_exporter(csv_exporter($logs, ['id', 'facebook_user_id'])) ?>" download="report.csv" target="_blank" class="align-self-start btn btn-light"><i class="fas fa-file-csv"></i> <?= $language->global->export_csv ?></a>
        </div>
