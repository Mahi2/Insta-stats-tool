        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                <div class="form-group mt-5">
                    <input type="text" name="email" class="form-control form-control-border" value="<?= $email ?>" placeholder="<?= $language->resend_activation->input->email ?>" aria-label="<?= $language->resend_activation->input->email ?>" required="required" />
                </div>
